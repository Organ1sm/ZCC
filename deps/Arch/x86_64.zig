...
pub const Register = enum(u8) {
    ...
    pub fn low_id(self: Register) u3 {
        return @as(u3, @truncate(@intFromEnum(self)));
    }
    ...
    pub fn to64(self: Register) Register {
        return @as(Register, @enumFromInt(self.id()));
    }

    /// Convert from any register to its 32 bit alias.
    pub fn to32(self: Register) Register {
        return @as(Register, @enumFromInt(@as(u8, self.id()) + 16));
    }

    /// Convert from any register to its 16 bit alias.
    pub fn to16(self: Register) Register {
        return @as(Register, @enumFromInt(@as(u8, self.id()) + 32));
    }

    /// Convert from any register to its 8 bit alias.
    pub fn to8(self: Register) Register {
        return @as(Register, @enumFromInt(@as(u8, self.id()) + 48));
    }
...
pub const CalleePreservedRegs = [_]Register{ .rax, .rcx, .rdx, .rsi, .rdi, .r8, .r9, .r10, .r11 };
pub const CABIIntParamRegs = [_]Register{ .rdi, .rsi, .rdx, .rcx, .r8, .r9 };
pub const CABIIntReturnRegs = [_]Register{ .rax, .rdx };
...
pub const Encoder = struct {
    ...
    pub fn init(code: *ArrayList(u8), maximumInstSize: u8) !Self {
        try code.ensureUnusedCapacity(maximumInstSize);
