...
#define EXPECTED_ERRORS \
    ...
    "u8-character-constant.c:8:26: error: character too large for enclosing character literal type" \
    "u8-character-constant.c:9:26: error: Unicode character literals may not contain multiple characters" \
