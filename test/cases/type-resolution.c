...
#define EXPECTED_ERRORS "type-resolution.c:24:5: warning: pointer type mismatch ('int *' and 'float *') [-Wpointer-type-mismatch]" \
    "test-helpers.h:3:88: note: expanded from here" \
    "type-resolution.c:24:30: note: expanded from here" \
    "type-resolution.c:25:5: warning: pointer type mismatch ('int *' and '_Atomic(int) *') [-Wpointer-type-mismatch]" \
    "test-helpers.h:3:88: note: expanded from here" \
    "type-resolution.c:25:30: note: expanded from here" \
