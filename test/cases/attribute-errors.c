...
#define EXPECTED_ERRORS "attribute-errors.c:4:24: error: 'access' attribute takes at least 2 argument(s)" \
    "attribute-errors.c:5:31: warning: unknown `access` argument. Possible values are: 'read_only', 'read_write', 'write_only', 'none'" \
    ...
    "attribute-errors.c:21:29: warning: unknown `simd` argument. Possible values are: \"notinbranch\", \"inbranch\"" \
