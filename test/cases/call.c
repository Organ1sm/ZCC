...
#define EXPECTED_ERRORS "call.c:16:7: error: passing 'void' to parameter of incompatible type '_Bool'" \
    ...
    "call.c:61:19: warning: passing arguments to without a prototype is deprecated in all versions of C and is not supported in C23 [-Wdeprecated-non-prototype]" \
