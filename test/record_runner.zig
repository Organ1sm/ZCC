...
pub fn main() !void {
    ...
    const fixed_buffer = try gpa.alloc(u8, 1024 * 1024 * 16);
...
const compErr = blk: {
    ...
    break :blk std.ComptimeStringMap(ExpectedFailure, .{
        ...
        .{
            "x86-i586-linux-gnu:Gcc|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0019",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-gnu:Gcc|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0019",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i586-linux-musl:Gcc|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i586-linux-musl:Gcc|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-linux-musl:Gcc|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0001",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0002",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0004",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0006",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0008",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0010",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0013",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0015",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0016",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0017",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0019",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0022",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0032",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0033",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0034",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0035",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0038",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0040",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0041",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0051",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0054",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0055",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0056",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0059",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0061",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0073",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i586-windows-msvc:Msvc|0074",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i586-windows-msvc:Msvc|0078",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-freebsd-gnu:Clang|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0018",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-freebsd-gnu:Clang|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0018",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-haiku-gnu:Clang|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0018",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-linux-android:Clang|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-linux-android:Clang|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-android:Clang|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0019",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-gnu:Gcc|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0019",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-linux-musl:Gcc|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-linux-musl:Gcc|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-linux-musl:Gcc|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0018",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-netbsd-gnu:Clang|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0002",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0013",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0018",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0024",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0043",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0054",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0055",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0060",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0061",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0062",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0087",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-openbsd-gnu:Clang|0088",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-uefi-msvc:Msvc|0016",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-uefi-msvc:Msvc|0017",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-uefi-msvc:Msvc|0032",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-uefi-msvc:Msvc|0033",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-gnu:Gcc|0035",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0037",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0039",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0040",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-gnu:Gcc|0068",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0069",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0071",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0072",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0073",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
        ...
        .{
            "x86-i686-windows-gnu:Gcc|0079",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0080",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0081",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
            "x86-i686-windows-gnu:Gcc|0082",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0001",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0002",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0004",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0006",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0008",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0010",
            .{ .parse = false, .layout = true, .extra = true, .offset = true },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0013",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0015",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0016",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0017",
            .{ .parse = false, .layout = true, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0019",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0022",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0032",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0033",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0034",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0035",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0038",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0040",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0041",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0051",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0054",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0055",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0056",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0059",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0061",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0073",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
            "x86-i686-windows-msvc:Msvc|0074",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
        ...
        .{
            "x86-i686-windows-msvc:Msvc|0078",
            .{ .parse = false, .layout = false, .extra = true, .offset = false },
        },
        .{
