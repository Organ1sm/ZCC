...
suppressVersion: ?LangOpts.Standard = null,
suppressUnlessVersion: ?LangOpts.Standard = null,
...
pub const incompatible_return_sign: Diagnostic = .{
    .fmt = incompatible_return.fmt ++ PointerSignMessage,
    .kind = .warning,
    .opt = .@"pointer-sign",
};
...
pub const incompatible_ptr_arg_sign: Diagnostic = .{
    .fmt = incompatible_ptr_arg.fmt ++ PointerSignMessage,
    .kind = .warning,
    .opt = .@"pointer-sign",
};
...
pub const incompatible_ptr_init_sign: Diagnostic = .{
    .fmt = incompatible_ptr_init.fmt ++ PointerSignMessage,
    .opt = .@"pointer-sign",
    .kind = .warning,
};
...
pub const incompatible_ptr_assign_sign: Diagnostic = .{
    .fmt = incompatible_ptr_assign.fmt ++ PointerSignMessage,
    .opt = .@"pointer-sign",
    .kind = .warning,
};
...
pub const unsigned_bit_int_too_big: Diagnostic = .{
    .fmt = "{s}unsigned _BitInt of bit sizes greater than " ++ std.fmt.comptimePrint("{d}", .{Compilation.BitIntMaxBits}) ++ " not supported",
    .kind = .@"error",
};

pub const signed_bit_int_too_big: Diagnostic = .{
    .fmt = "{s}signed _BitInt of bit sizes greater than " ++ std.fmt.comptimePrint("{d}", .{Compilation.BitIntMaxBits}) ++ " not supported",
    .kind = .@"error",
};
