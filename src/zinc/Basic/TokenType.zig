pub const TokenType = enum(u8) {
    ...
    pub fn lexeme(id: TokenType) ?[]const u8 {
        return switch (id) {
            ...
            .KeywordSigned1 => "__signed",
            .KeywordSigned2 => "__signed__",
            ...
            .KeywordFloat128_ => "_Float128",
            .KeywordFloat128__ => "__float128",
            ...
            .KeywordFastcall => "__fastcall",
            .KeywordFastcall2 => "_fastcall",
            .KeywordRegcall => "__regcall",
            .KeywordCdecl => "__cdecl",
            .KeywordCdecl2 => "_cdecl",
            .KeywordForceInline => "__forceinline",
            .KeywordForceInline2 => "_forceinline",
            .KeywordUnaligned => "__unaligned",
            .KeywordUnaligned2 => "_unaligned",
