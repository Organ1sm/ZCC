...
pub fn renderExtra(comp: *Compilation, m: anytype) void {
    ...
    for (comp.diag.list.items) |msg| {
        ...
        switch (msg.tag) {
            ...
            .spec_from_typedef => m.print("typedef is '{s}'", .{msg.extra.str}),
            ...
            .missing_tok_builtin => m.print("missing '{s}', after builtin feature-check macro", .{msg.extra.tokenId.expected.symbol()}),
